...
def update_scholar_stats():
    try:
        ...
        for i, pub in enumerate(publications):
            ...
            abstract = (
                filled_pub.get('bib', {}).get('abstract')
                or filled_pub.get('abstract')
                or filled_pub.get('summary', 'Abstract not available')
            )
